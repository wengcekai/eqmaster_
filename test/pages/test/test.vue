  ...
  <view class="container">
    ...
    <template v-if="currentPage === 'test'">
      ...
      <view class="banner-container">
        <image
          class="logo"
          src="/static/onboarding/location.png"
          mode="aspectFit"
        />
        <view class="test">
          <text class="room-text">{{ scenarioData.location }}</text>
    ...
    <template v-else-if="currentPage === 'test2'">
      <view class="options-container">
        <view
          v-for="(option, index) in scenarioData && scenarioData.options
        ...
        >
          <text
            class="text-content1"
            :style="{ color: option.textColor || 'white' }"
          >
            {{ option.text }}
          </text>
        </view>
  ...
  methods: {
    ...
    nextPage() {
      ...
      this.chatHistory.push({
        ...
        selectedOption:
          this.scenarioData.options[this.selectedOptionIndex].text,
      });
